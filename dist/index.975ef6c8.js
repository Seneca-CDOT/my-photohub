...
var _poppins = require("@fontsource/poppins");
var _photoswipeCss = require("photoswipe/dist/photoswipe.css");
var _photoswipeEsm = require("photoswipe/dist/photoswipe.esm");
var _photoswipeEsmDefault = parcelHelpers.interopDefault(_photoswipeEsm);
var _galleryCss = require("../css/gallery.css");
var _photoswipeLightboxEsm = require("photoswipe/dist/photoswipe-lightbox.esm");
var _photoswipeLightboxEsmDefault = parcelHelpers.interopDefault(_photoswipeLightboxEsm);
const lightbox = new (0, _photoswipeLightboxEsmDefault.default)({
    gallery: "#gallery",
    children: "a",
    pswpModule: (0, _photoswipeEsmDefault.default)
});
lightbox.init();

},{"@fontsource/poppins":"7TsgH","photoswipe/dist/photoswipe.css":"855Ic","photoswipe/dist/photoswipe.esm":"eEaUx","../css/gallery.css":"a2O9e","photoswipe/dist/photoswipe-lightbox.esm":"3kRIy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7TsgH":[function() {},{}],"855Ic":[function() {},{}],"eEaUx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
 ...
 */ class Keyboard {
   ...
   */ _onFocusIn(e) {
        ...
        if (document !== e.target && template !== e.target && !template.contains(e.target)) // focus root element
        template.focus();
    }
}
...
},{}],"a2O9e":[function() {},{}],"3kRIy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 * @template T
 * @typedef {import('../types.js').Type<T>} Type<T>
 */ /** @typedef {import('../photoswipe.js').default} PhotoSwipe */ /** @typedef {import('../photoswipe.js').PhotoSwipeOptions} PhotoSwipeOptions */ /** @typedef {import('../photoswipe.js').DataSource} DataSource */ /** @typedef {import('../slide/content.js').default} Content */ /** @typedef {import('../core/eventable.js').PhotoSwipeEventsMap} PhotoSwipeEventsMap */ /** @typedef {import('../core/eventable.js').PhotoSwipeFiltersMap} PhotoSwipeFiltersMap */ /**
 * @template T
 * @typedef {import('../core/eventable.js').EventCallback<T>} EventCallback<T>
 */ /**
 * PhotoSwipe Lightbox
 ...
 */ class PhotoSwipeLightbox extends PhotoSwipeBase {
   ...
   */ preload(index, dataSource) {
        ...
        if (isPswpClass(options.pswpModule)) promiseArray.push(Promise.resolve(options.pswpModule));
        else if (pswpModuleType === "string") throw new Error("pswpModule as string is no longer supported");
        else if (pswpModuleType === "function") promiseArray.push(/** @type {() => Promise<Type<PhotoSwipe>>} */ (0, options.pswpModule)());
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequireb488")
